...
6. Execute os scripts `python src/using_python_old.py`, `poetry run python src/using_pandas.py`, `poetry run python src/using_dask.py`, `poetry run python src/using_polars.py` e `poetry run python src/using_duckdb.py` através de um terminal ou ambiente de desenvolvimento que suporte Python.
...
Estudei esse projeto na Jornada de Dados, uma escola para formar Engenheiros de Dados.